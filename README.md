...
- First of all, we welcome the player to the game and ask them for their username. We then make sure that that username isn't taken by someone else who has played the game. This is analogous to the **same person not playing the game twice** in real life. We then explain the instructions for the game to the user, but they may choose to skip over that. Then once the game starts, we ask the player a series of questions.
